...
srun python ./train.py agent=taco task=quadruped_run seed=1 exp_name=quadruped_run_1 
srun python ./train.py agent=taco task=quadruped_run seed=1 exp_name=quadruped_run_2
